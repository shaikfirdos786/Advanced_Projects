...
def add_cafe():
    ...
    if form.validate_on_submit():
        form_info = form.data
        del form_info['submit']
        del form_info['csrf_token']
        with open("cafe-data.csv", "a", newline='', encoding='utf-8') as csv_data:
            writer_object = csv.writer(csv_data)
            writer_object.writerow(form_info.values())
